...
//filter the list of inventors for those who were born in the 1500s
 const bornInFifteen = inventors.filter(inventors => inventors.year > 1500 && inventors.year < 1600)
 ...
 const firstAndLast = inventors.map(inventors => inventors.first + ` ` + inventors.last)
